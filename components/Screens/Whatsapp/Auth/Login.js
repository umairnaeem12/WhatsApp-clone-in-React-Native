  ...
  return (
    <ScrollView>
      <View style={styles.conatiner}>
        ...
        <TouchableOpacity style={styles.forgetbutton}><Text style={{ textAlign: 'right' }}>Forget Password?</Text></TouchableOpacity>
        <TouchableOpacity style={styles.siginbutton}><Text style={styles.siginbuttontext}>Sign in</Text></TouchableOpacity>
        <View style={styles.bottomtext}>
          <Text>Don't have an account? </Text>
          <TouchableOpacity onPress={() => navigation.navigate('Whatsapp')}><Text style={{ color: 'red', fontWeight: '800' }}>Register</Text></TouchableOpacity>
        </View>
      </View>
    </ScrollView>
  )
